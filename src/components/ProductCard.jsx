        ...
        <Link to=":id" className="product-card position-relative">
          ...
          <div className="product-details">
            ...
            <p className={`description ${grid === 12 ? "d-block" : "d-none"}`}>
              ...
              voluptate voluptatibus amet corporis laborum ratione error
              deserunt, optio exercitationem tempora neque dolore illum
              voluptates officiis. Libero ex id voluptas dignissimos.
            </p>
